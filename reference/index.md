...
- [`identify_outliers()`](https://ecamenen.github.io/GimmeMyStats/reference/identify_outliers.md)
  : Identifies outliers in a numeric vector
- [`mcor_test()`](https://ecamenen.github.io/GimmeMyStats/reference/mcor_test.md)
  : Multiple correlation test
- [`post_hoc_chi2()`](https://ecamenen.github.io/GimmeMyStats/reference/post_hoc_chi2.md)
